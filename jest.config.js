...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/w4/wsmgy61s1rd9q_jnmq2n3v0h0000gn/T/jest_dx",
  ...
  // A path to a module which exports an async function that is triggered once before all test stes
  ...
  // The paths to modules that run some code to configure or set up the testing env before each test
  // setupFiles: [],
  ...
  // The number of seconds after which a test is considered as slow & reported as such in results.
  // slowTestThreshold: 5,
